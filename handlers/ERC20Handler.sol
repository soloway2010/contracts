    ...
    ERC20Safe
{
    ...
    //resourceID => min amount of token allowed
    mapping(bytes32 => uint256) public _minDeposits;
    ...
    */
    ...
    function getMinDeposits(bytes32 resourceID) external view returns(uint256) {
        return _minDeposits[resourceID];
    }

    function setMinDeposits(bytes32 resourceID, uint256 minAmount) external onlyOwner{
        _minDeposits[resourceID] = minAmount;
    }
    ...
    function deposit(
        ...
        uint256 tokensLocked = getBalance(tokenAddress);
        require(_minDeposits[resourceID] == 0 || tokensLocked + amount <= _minDeposits[resourceID], "amount greater than min deposit allowed");
