...
contract ERC721Safe {
    ...
    /**
        @notice Used to approve ERC721s.
        @param tokenAddress Address of ERC721 to approve.
        @param spender Spender of token.
        @param tokenID ID of token to approve.
     */
    function approveERC721(address tokenAddress, address spender, uint256 tokenID) internal {
        IERC721 erc721 = IERC721(tokenAddress);
